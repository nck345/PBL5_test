...
## Filename format
`<ADL_OR_FALL_OR_SCENARIO_CODE>_<SENSOR_CODE>_<SUBJECT_ID>_<TRIAL_NO>.txt`
...
### 1st Scenario of Leaving the Home (SLH)
*Total duration 125s at max (1 trial/participant)*
...
### 2nd Scenario of Being at work (SBW)
*Total duration 185s at max (1 trial/participant)*
...
### 3rd Scenario of Leaving work (SLW)
*Total duration 185s at max (1 trial/participant)*
...
### 4th Scenario of Being Exercise (SBE)
*Total duration 125s at max (1 trial/participant)*
...
### 5th Scenario of Returning at Home (SRH)
*Total duration 155s at max (1 trial/participant)*
...
- **Chatzaki Charikleia**
  ...
  M.Sc. Thesis, Dept. Informatics Engineering, Heraklion, Crete, Greece, 2016
